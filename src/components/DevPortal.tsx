    ...
    <div className="min-h-screen text-slate-100 bg-[#070b12] -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-10">
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <div className="border-b border-stone-800/80 pb-8 space-y-4">
          <div className="flex items-center space-x-2 text-emerald-400 text-xs font-mono uppercase tracking-widest">
          ...
          <p className="text-stone-300 text-base sm:text-lg leading-relaxed font-sans max-w-3xl">
        ...
        <section className="space-y-4">
          ...
          <div className="relative group bg-[#0b1320] border border-stone-800/90 rounded-2xl p-5 flex items-center justify-between shadow-xl">
            <code className="text-emerald-400 font-mono text-sm sm:text-base selection:bg-emerald-950 font-semibold tracking-wide overflow-x-auto py-1">
              https://engine.sautifarm.co/v1
            </code>
            <button
              onClick={() => copyToClipboard("https://engine.sautifarm.co/v1", "base-url")}
              className="ml-3 p-2 rounded-xl bg-stone-900/80 border border-stone-800 text-stone-400 hover:text-emerald-400 hover:border-emerald-500/40 transition shrink-0"
              title="Copy endpoint"
            >
              {copiedSnippet === 'base-url' ? <Check className="w-4 h-4 text-emerald-400" /> : <Copy className="w-4 h-4" />}
            </button>
          </div>

          <p className="text-stone-400 text-xs sm:text-sm">
            Works out of the box with any official OpenAI SDK. Simply modify the <code className="bg-stone-900 px-1.5 py-0.5 rounded text-stone-300 font-mono text-xs">base_url</code> parameter.
          </p>
        </section>
        ...
        <section className="space-y-4">
          ...
          <p className="text-stone-300 text-sm sm:text-base leading-relaxed">
            Requests must authenticate by passing your SautiFarm API key in the custom <code className="bg-[#082218] text-emerald-400 border border-emerald-800/80 px-2 py-0.5 rounded text-xs sm:text-sm font-mono font-bold">X-API-Key</code> request header.
          </p>
          <p className="text-stone-300 text-sm sm:text-base">
            ...
            <button
              ...
              className="text-emerald-400 hover:text-emerald-300 underline font-semibold transition inline-flex items-center space-x-1"
            >
        ...
        <section className="space-y-6">
          <div className="flex flex-wrap items-center gap-3">
            <span className="bg-[#082218] border border-emerald-800 text-emerald-400 text-xs font-mono font-bold px-3 py-1 rounded-full uppercase tracking-wider">
              POST
            </span>
          ...
          <div className="space-y-3">
            <h3 className="text-xs sm:text-sm font-mono font-bold uppercase tracking-widest text-stone-300">
              REQUEST BODY PARAMETERS
            </h3>

            <div className="bg-[#0b1320] border border-stone-800/90 rounded-2xl overflow-hidden shadow-xl">
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs sm:text-sm border-collapse">
                  <thead>
                    <tr className="border-b border-stone-800/80 bg-stone-950/40 text-stone-400 font-mono text-xs uppercase tracking-wider">
                  ...
                  <tbody className="divide-y divide-stone-800/70 text-stone-300">
                    <tr className="hover:bg-stone-900/30 transition">
                      <td className="py-3 px-4 font-mono text-emerald-400 font-bold">model</td>
                      <td className="py-3 px-4 font-mono text-stone-400">string</td>
                      <td className="py-3 px-4 text-emerald-300 font-semibold">Yes</td>
                      <td className="py-3 px-4 text-stone-300">"sautifarm-agent" (or any designated string)</td>
                    </tr>
                    <tr className="hover:bg-stone-900/30 transition">
                      <td className="py-3 px-4 font-mono text-emerald-400 font-bold">messages</td>
                      <td className="py-3 px-4 font-mono text-stone-400">array</td>
                      <td className="py-3 px-4 text-emerald-300 font-semibold">Yes</td>
                      <td className="py-3 px-4 text-stone-300">List of conversational &#123;role, content&#125; objects</td>
                    </tr>
                    <tr className="hover:bg-stone-900/30 transition">
                      <td className="py-3 px-4 font-mono text-emerald-400 font-bold">stream</td>
                      <td className="py-3 px-4 font-mono text-stone-400">boolean</td>
                      <td className="py-3 px-4 text-stone-400 font-medium">No</td>
                      <td className="py-3 px-4 text-stone-300">Activate Server-Sent Events (SSE) stream outputs</td>
                    </tr>
                    <tr className="hover:bg-stone-900/30 transition">
                      <td className="py-3 px-4 font-mono text-emerald-400 font-bold">user</td>
                      <td className="py-3 px-4 font-mono text-stone-400">string</td>
                      <td className="py-3 px-4 text-stone-400 font-medium">No</td>
                      <td className="py-3 px-4 text-stone-300">A unique developer-defined identifier for your end-user</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="bg-[#0b1320] border border-stone-800/90 rounded-2xl overflow-hidden shadow-xl">
              <div className="overflow-x-auto">
                <table className="w-full text-left text-xs sm:text-sm border-collapse">
                  ...
                  <tbody className="divide-y divide-stone-800/70 text-stone-300">
                    <tr className="hover:bg-stone-900/30 transition">
                      <td className="py-3 px-4 font-mono text-emerald-400 font-bold">system</td>
                      <td className="py-3 px-4 font-mono text-stone-400">string</td>
                      <td className="py-3 px-4 text-stone-300">Configure custom behavior or inject specific agronomy constraints.</td>
                    </tr>
                    <tr className="hover:bg-stone-900/30 transition">
                      <td className="py-3 px-4 font-mono text-emerald-400 font-bold">user</td>
                      <td className="py-3 px-4 font-mono text-stone-400">string | array</td>
                      <td className="py-3 px-4 text-stone-300">The farmer prompt. Array structure supports image URL payloads for multimodal disease recognition.</td>
                    </tr>
                    <tr className="hover:bg-stone-900/30 transition">
                      <td className="py-3 px-4 font-mono text-emerald-400 font-bold">assistant</td>
                      <td className="py-3 px-4 font-mono text-stone-400">string</td>
                      <td className="py-3 px-4 text-stone-300">Previous model response content to build multi-turn conversational memory.</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="flex items-center space-x-1.5 text-xs text-stone-400 hover:text-emerald-400 transition bg-stone-900/60 px-3 py-1.5 rounded-lg border border-stone-800"
                >
              ...
              <pre className="bg-[#0b1320] border border-stone-800/90 rounded-2xl p-5 font-mono text-xs sm:text-sm text-emerald-300/90 overflow-x-auto leading-relaxed shadow-xl">
        ...
        <section className="space-y-6 pb-12">
          ...
          <div className="bg-[#0b1320] border border-stone-800/90 rounded-2xl p-7 space-y-4 shadow-xl">
            <ol className="space-y-3.5 text-sm sm:text-base text-stone-300 list-decimal list-inside leading-relaxed">
              <li className="pl-1">
        ...
        <section id="sandbox-section" className="space-y-6 pt-2 pb-12 scroll-mt-28">
          <div className="flex items-center justify-between">
            ...
            <span className="bg-emerald-950/80 border border-emerald-700 text-emerald-300 text-xs px-3 py-1 rounded-full font-mono font-medium hidden sm:inline-block">
              Status: Live &amp; Ready
            </span>
          </div>

          <div className="bg-[#0b1320] border border-stone-800/90 rounded-2xl p-6 sm:p-7 space-y-4 shadow-xl">
            <div className="space-y-2">
              <label htmlFor="test-prompt" className="block text-xs font-mono font-bold uppercase tracking-wider text-stone-300">
                User Query Payload
              </label>
              <div className="flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="flex-1 bg-stone-950 border border-stone-800 rounded-xl px-4 py-2.5 text-sm text-stone-100 focus:outline-none focus:border-emerald-500 font-mono"
                />
                <button
            ...
            {sandboxOutput && (
              <div className="space-y-2 pt-2 animate-fadeIn">
                ...
                <pre className="bg-stone-950 border border-stone-800 rounded-xl p-4 font-mono text-xs text-emerald-300 overflow-x-auto leading-relaxed">
