  ...
  return (
    <div className="min-h-screen text-slate-100 bg-[#070b12] -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-10">
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <div className="sticky top-20 z-30 flex items-center justify-center gap-2 overflow-x-auto py-2 px-3 bg-stone-900/90 backdrop-blur-md rounded-2xl border border-stone-800 shadow-xl max-w-xl mx-auto">
          <button
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div 
                ...
                className="bg-[#0b1320] border border-stone-800/90 rounded-2xl p-7 flex flex-col items-center justify-center text-center space-y-3 hover:border-emerald-500/40 transition shadow-xl"
              >
        ...
        <section id="financial-reports" ref={reportsRef} className="scroll-mt-28 space-y-6 pt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div 
              ...
              className="bg-[#0b1320] border border-stone-800/90 rounded-2xl p-6 sm:p-7 space-y-4 hover:border-emerald-500/40 transition shadow-lg"
            >
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between items-center py-2 border-b border-stone-800/70">
                  <span className="text-stone-300">Farmer Fee (Direct SMS/USSD)</span>
                  <span className="text-emerald-400 font-mono font-bold">KES 5.00 – 10.00</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-stone-800/70">
                  <span className="text-stone-300">Estimated AI Compute &amp; SMS Cost</span>
                  <span className="text-stone-400 font-mono">~ KES 1.20</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-stone-800/70">
                  <span className="text-stone-300">Gross Margin per Consultation</span>
                  <span className="text-emerald-300 font-mono font-bold">&gt; 75%</span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="text-stone-300">Crop Value Protected (Average)</span>
