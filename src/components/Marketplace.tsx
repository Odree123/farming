  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="bg-white rounded-2xl p-6 border border-stone-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button
          onClick={openCart}
          className="inline-flex items-center space-x-2 bg-amber-500 hover:bg-amber-400 text-stone-950 px-4 py-2.5 rounded-xl text-xs font-bold shadow transition"
        >
          <ShoppingBag className="w-4 h-4" />
          <span>Fungua Kikapu (View Cart)</span>
        </button>
      </div>
      ...
      <div className="bg-white rounded-2xl p-4 border border-stone-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-3">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 text-xs sm:text-sm bg-stone-50 border border-stone-300 rounded-xl outline-none focus:ring-2 focus:ring-emerald-600 focus:bg-white transition"
          />
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {filteredProducts.map((product) => {
          ...
          return (
            <div
              key={product.id}
              className="bg-white rounded-2xl border border-stone-200/90 overflow-hidden shadow-sm hover:shadow-md hover:border-emerald-500/80 transition duration-200 flex flex-col justify-between"
            >
              ...
              <div className="relative aspect-[4/3] bg-stone-100 overflow-hidden group">
                ...
                <div className="absolute top-2.5 left-2.5">
                  <span className="bg-emerald-900/90 backdrop-blur-sm text-amber-300 text-[10px] font-bold px-2 py-0.5 rounded-md flex items-center space-x-1">
              ...
              <div className="p-4 space-y-2.5 flex-1 flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between text-[11px] text-stone-500 mb-1">
                    <span className="font-semibold text-emerald-800">{product.brand}</span>
                ...
                <div className="pt-2 border-t border-stone-100 space-y-1 text-[11px] text-stone-500">
                  <div className="flex items-center space-x-1 text-emerald-900 font-medium">
                ...
                <div className="pt-3 border-t border-stone-100 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-xl text-xs font-bold transition flex items-center space-x-1 shadow-sm ${
                      isAdded
