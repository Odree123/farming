...
export const MarketPrices: React.FC<MarketPricesProps> = ({ currentLanguage }) => {
  ...
  const estimatedTransport = bagsCount * 450; // KES 450 per bag transit
  ...
  return (
    <div className="space-y-8 pb-12">
      ...
      <div className="bg-white rounded-2xl p-6 border border-stone-200 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="inline-flex items-center space-x-2 bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-xs font-semibold mb-2">
        ...
        <button
          ...
          className="inline-flex items-center space-x-2 bg-emerald-800 hover:bg-emerald-700 text-white px-4 py-2.5 rounded-xl text-xs font-semibold shadow transition"
        >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          ...
          <div className="flex items-center space-x-3 text-xs">
            <span className="flex items-center text-emerald-700 font-medium">
              <span className="w-2.5 h-2.5 bg-emerald-600 rounded-full mr-1"></span> Mombasa
            </span>
            <span className="flex items-center text-blue-700 font-medium">
              <span className="w-2.5 h-2.5 bg-blue-600 rounded-full mr-1"></span> Nairobi
            </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 text-xs sm:text-sm bg-stone-50 border border-stone-300 rounded-xl outline-none focus:ring-2 focus:ring-emerald-600 focus:bg-white transition"
            />
          </div>
          ...
          <div>
            <select
              ...
              className="w-full py-2 px-3 text-xs sm:text-sm bg-stone-50 border border-stone-300 rounded-xl outline-none focus:ring-2 focus:ring-emerald-600"
            >
              {categories.map((c) => (
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs sm:text-sm">
            <thead className="bg-stone-100/80 text-stone-600 uppercase text-[10px] tracking-wider border-b border-stone-200">
              <tr>
                <th className="py-3 px-3">Zao / Commodity</th>
                <th className="py-3 px-3">Kipimo / Unit</th>
                <th className="py-3 px-3">Soko / Market</th>
                <th className="py-3 px-3 text-right">Bei ya Jumla (Wholesale)</th>
                <th className="py-3 px-3 text-right">Rejareja (Retail)</th>
                <th className="py-3 px-3 text-center">Mabadiliko (24h)</th>
                <th className="py-3 px-3">Hali ya Ugavi</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-stone-100">
              {filteredPrices.map((p) => (
                <tr key={p.id} className="hover:bg-stone-50 transition">
                  ...
                  <td className="py-3 px-3 text-stone-600 font-medium">{p.unit}</td>
                  ...
                  <td className="py-3 px-3 text-right font-extrabold text-stone-900 font-mono">
      ...
      {/* Arbitrage Profit Opportunity Calculator */}
      <div className="bg-gradient-to-br from-stone-900 to-emerald-950 text-white rounded-2xl p-6 border border-emerald-800/80 shadow-lg space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 text-stone-900 text-xs">
          ...
          <div className="bg-emerald-800/60 border border-emerald-600 rounded-xl p-2.5 flex flex-col justify-center text-white">
            <span className="text-[10px] text-emerald-200 uppercase font-semibold">Faida Halisi (Net Profit):</span>
        ...
        <div className="text-[11px] text-stone-400 flex items-center space-x-2 pt-1">
          ...
          <div className="bg-white rounded-2xl max-w-md w-full p-6 space-y-4 shadow-2xl border border-stone-200">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2 text-emerald-900">
                ...
                <h3 className="font-extrabold text-sm sm:text-base">Weka Ilani ya Bei (SMS Alert)</h3>
              </div>
              <button
            ...
            <form onSubmit={handleSetAlert} className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 text-xs bg-stone-50 border border-stone-300 rounded-xl outline-none focus:ring-2 focus:ring-emerald-600"
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-emerald-800 hover:bg-emerald-700 text-white font-bold py-2.5 rounded-xl text-xs transition"
              >
