      ...
      <div className="max-w-5xl mx-auto space-y-16">
        ...
        <section id="our-journey" ref={journeyRef} className="pt-6 scroll-mt-28 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div 
              id="journey-item-1"
              className="bg-[#0b1320] border border-stone-800/90 rounded-2xl p-6 sm:p-7 flex flex-col sm:flex-row items-start gap-5 hover:border-emerald-500/40 transition shadow-lg"
            >
              <div className="bg-[#062419] border border-emerald-700/60 text-emerald-400 font-mono text-sm font-semibold px-4 py-1.5 rounded-lg flex items-center justify-center shrink-0">
                2025
              </div>
        ...
        <section id="leadership" ref={leadershipRef} className="pt-6 scroll-mt-28 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div 
              ...
              className="bg-[#0b1320] border border-stone-800/90 rounded-2xl p-6 sm:p-7 space-y-5 hover:border-emerald-500/40 transition shadow-lg"
            >
              <div className="w-12 h-12 rounded-full bg-[#082218] border border-emerald-800 flex items-center justify-center text-emerald-400 font-bold text-sm">
                MU
              </div>
        ...
        <section id="partners" ref={partnersRef} className="pt-6 scroll-mt-28 space-y-8 pb-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 pt-4">
            <div 
              id="partner-maseno"
              className="bg-[#0b1320] border border-stone-800/90 rounded-xl p-4 text-center flex items-center justify-center text-sm font-medium text-stone-200 hover:border-emerald-500/50 hover:text-emerald-300 transition"
            >
              Maseno University
            </div>
            <div 
            ...
            <div 
              ...
              className="bg-[#0b1320] border border-stone-800/90 rounded-xl p-4 text-center flex items-center justify-center text-sm font-medium text-stone-200 hover:border-emerald-500/50 hover:text-emerald-300 transition sm:col-span-2 md:col-span-1"
            >
              Kenya National Farmers Federation
            </div>
            <div 
              id="partner-aatf"
              className="bg-[#0b1320] border border-stone-800/90 rounded-xl p-4 text-center flex items-center justify-center text-sm font-medium text-stone-200 hover:border-emerald-500/50 hover:text-emerald-300 transition col-span-2 sm:col-span-1 md:col-span-2"
            >
